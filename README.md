...
Kura is not another meeting notetaker. It's a team member that learns. It joins your meetings, builds a knowledge graph connecting people, projects, decisions, and action items across every conversation, and grows more capable over time.
...
3. **Async Team Member** — @Kura in Slack/Teams, answers from organizational memory
